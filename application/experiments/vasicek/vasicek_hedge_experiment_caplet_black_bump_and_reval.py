...
from application.engine.black import black_cpl, black_cpl_iv
...
if __name__ == '__main__':
    ...
    start = torch.tensor(1.5)
    delta = torch.tensor(0.25)

    model = Vasicek(a, b, sigma, r0, False, False, measure)

    strike = model.calc_swap_rate(r0, start.view(1), delta)  # 0.08359273
    ...
    plt.plot(fwdT, a, 'o', alpha=1., color='gray', label='Delta(T-1) vs Fwd(T)')
    plt.legend()
