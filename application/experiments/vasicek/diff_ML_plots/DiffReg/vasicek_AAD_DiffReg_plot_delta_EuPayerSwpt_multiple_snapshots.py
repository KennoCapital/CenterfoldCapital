...
if __name__ == '__main__':
    ...
    for i in range(len(T)):
        ...
        ax[row, col].plot(X_test, z_pred, label='DiffReg', color='orange')
    ...
    fig.suptitle('Delta Estimation of 1Y6Y3M European payer swaption', x=0.5, y=0.9)
    plt.show()
    #plt.savefig(get_plot_path('vasicek_AAD_DiffReg_plot_delta_EuPayerSwpt_multiple_snapshots.png'), dpi=400)
