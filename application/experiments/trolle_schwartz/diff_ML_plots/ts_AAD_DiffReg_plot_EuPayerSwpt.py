...
if __name__ == '__main__':
    # Settings
    path_name = get_plot_path('10_ts_AAD_DiffReg_EuPayerSwpt_{}.png')
    plot_nodes = 100
    ...
    y_pred, z_pred = diff_reg_fit_predict(x_train, y_train, z_train, x_test, diff_reg, scalar)
    ...
    y_pred2, z_pred2 = diff_reg_fit_predict(x_train, y_train, z_train, x_test2, diff_reg, scalar)
